# Expert Database for AI Boardroom

This is a comprehensive database of potential advisors across multiple domains. During boardroom setup, the skill uses this database to recommend 6-8 experts matched to the user's specific goals, skills, and expertise areas.
...
1. Their current abilities/skills
2. What they want to accomplish
3. Their 3-5 expertise areas

The skill searches this database to recommend experts whose proven methodologies and track records align with the user's specific context and goals.

---

## BUSINESS STRATEGY & REVENUE EXPERTS

### **Justin Welsh**
- **Core Expertise:** Multi-stream revenue architectures, solo entrepreneur to 7-figure scaling
- **Primary Methodologies:** Stacking revenue streams (courses → coaching → products), content-based authority, systematic offer creation
- **What He Built:** $5M+ in revenue across multiple streams while maintaining solo/small team structure
- **Best For:** Entrepreneurs wanting to build multi-stream revenue models, course creators, coaches, productized service owners
- **Key Frameworks:** Revenue stacking, audience building, offer architecture, content distribution
- **Questions to Ask Him:**
  - How do I sequence revenue streams as I scale?
  - How do I build authority without personal branding sacrifices?
  - How do I transition from service to products/courses/coaching?

---

### **Alex Hormozi**
- **Core Expertise:** Premium offer positioning, irresistible offer architecture, high-ticket pricing
- **Primary Methodologies:** Value equation framework (Dream Outcome + Perceived Likelihood - Time Delay - Effort/Sacrifice), guarantee structures, risk reversal
- **What He Built:** 8-figure business through irresistible offers; helped businesses 10x their pricing
- **Best For:** Service providers, coaches, info product creators, B2B positioning, government contract positioning
- **Key Frameworks:** Value equation, offer architecture, guarantee structures, pricing strategy, B2G positioning
- **Questions to Ask Him:**
  - How do I position this offer as irresistible?
  - What's the value equation for my offer?
  - How do I position for government contracts (B2G)?
  - How do I price premium without losing customers?

---

### **Seth Godin**
- **Core Expertise:** Marketing for remarkable ideas, positioning, brand strategy, permission marketing
- **Primary Methodologies:** Purple cow positioning, tribe building, remarkable products, permission marketing, narrative design
- **What He Built:** Multiple bestselling books, marketing revolution through ideas-first thinking
- **Best For:** Entrepreneurs with unique positioning, content creators, idea-driven businesses, thought leaders
- **Key Frameworks:** Purple cow positioning, tribe building, permission marketing, narrative design, scalable ideas
- **Questions to Ask Him:**
  - How do I make my business remarkable?
  - What's my tribe and how do I find them?
  - How do I tell the story of what I'm building?
  - How do I transition from competing on price to competing on ideas?

---

## POSITIONING & AUTHORITY EXPERTS

### **David C. Baker**
- **Core Expertise:** Expertise positioning for consultants, credible professional pivots, authority-based pricing
- **Primary Methodologies:** Horizontal expertise leverage, positioning through narrow focus, expertise development, authority signals
- **What He Built:** Authority framework for 100+ consultants and agencies; helping technical experts become positioning authorities
- **Best For:** Consultants pivoting industries, technical experts becoming trainers, service providers building authority, expertise-based businesses
- **Key Frameworks:** Horizontal expertise positioning, authority development, narrow focus strategy, credibility signals
- **Questions to Ask Him:**
  - How do I position my technical expertise as training authority?
  - How do I make a credible transition from [OLD] to [NEW]?
  - How do I prove expertise in a new domain?
  - What positioning strategy honors my background?

---

### **Donald Miller**
- **Core Expertise:** StoryBrand messaging framework, clarity of communication, customer-centric positioning
- **Primary Methodologies:** StoryBrand 7-part framework (Character, Problem, Guide, Plan, Call-to-Action, Success, Failure), clarity through story, message hierarchy
- **What He Built:** StoryBrand framework adopted by thousands of companies; communication clarity systems
- **Best For:** Companies with unclear messaging, entrepreneurs confused about positioning, B2B and B2G sales positioning, course creators/trainers
- **Key Frameworks:** StoryBrand messaging, clarity framework, value proposition articulation, customer-centric narrative
- **Questions to Ask Him:**
  - How do I clarify my positioning and messaging?
  - How do I help customers understand my value?
  - How do I position for government agencies (B2G)?
  - What's the story I should be telling?

---

### **Gary Vaynerchuk**
- **Core Expertise:** Personal branding, content distribution, multimedia strategy, platform building
- **Primary Methodologies:** Platform-agnostic content, personal brand development, multimedia distribution, micro-content strategy
- **What He Built:** Multi-platform authority across social media, content empire, brand agency VaynerMedia
- **Best For:** Personal brand builders, content creators, multi-platform strategies, authority development
- **Key Frameworks:** Platform strategy, content repurposing, personal branding, multimedia distribution
- **Questions to Ask Him:**
  - How do I build a multi-platform personal brand?
  - What's my content distribution strategy?
  - How do I leverage social platforms for authority?
  - How do I balance platform-specific strategies?

---

## PRODUCT & CURRICULUM EXPERTS

### **Tiago Forte**
- **Core Expertise:** Knowledge systematization, curriculum design, intellectual property architecture
- **Primary Methodologies:** CODE framework (Capture, Organize, Distill, Express), knowledge management, systematic knowledge products, building a second brain
- **What He Built:** Second Brain methodology; helping experts systematize knowledge into scalable products
- **Best For:** Technical experts, knowledge workers, curriculum designers, course creators, trainers, information product creators
- **Key Frameworks:** CODE framework, knowledge architecture, curriculum design, intellectual property systemization
- **Questions to Ask Him:**
  - How do I systematize my 20+ years of knowledge?
  - How do I design curriculum that's scalable?
  - How do I turn my expertise into teachable systems?
  - How do I organize knowledge for different audiences?

---

### **Arvid Kahl**
- **Core Expertise:** Product validation, bootstrapped approach, audience-first product development
- **Primary Methodologies:** Rapid validation, audience building before building, cost-effective testing, indie product strategy
- **What He Built:** Multiple indie products; founder of audience-driven platforms; bootstrapped to profitability
- **Best For:** Lean entrepreneurs, product builders, validation-first approach, low-cost testing, audience builders
- **Key Frameworks:** Audience-first product development, validation lean strategies, cost-effective testing, platform building
- **Questions to Ask Him:**
  - How do I validate demand before heavy investment?
  - How do I build an audience for my product?
  - What's a lean, low-cost way to test this?
  - How do I stay bootstrapped while scaling?

---

## OPERATIONS & SCALING EXPERTS

### **Dan Martell**
- **Core Expertise:** Scaling through delegation, time buyback, founder productivity, operations architecture
- **Primary Methodologies:** Buyback Principle, Replacement Ladder (Hire, Train, Reward, Replace yourself), time audits, delegation frameworks, automation
- **What He Built:** Scaling framework for founders; helped 1000+ entrepreneurs buy back their time; built multiple eight-figure companies
- **Best For:** Founders tired of working in the business, operations builders, delegation architects, scaling without founder burnout
- **Key Frameworks:** Buyback Principle, Replacement Ladder, time audits, delegation frameworks, founder productivity
- **Questions to Ask Him:**
  - How do I scale without working 80-hour weeks?
  - How do I delegate instructor responsibilities?
  - What operations do I automate vs. hire?
  - How do I build systems that don't require me?

---

### **Michael Gerber**
- **Core Expertise:** Business systems, documentation, replicable operations, business model architecture
- **Primary Methodologies:** Systems approach to business, process documentation, operational architecture, franchise-ready systems
- **What He Built:** E-myth framework; helped thousands build systematized businesses
- **Best For:** Scaling operations, building repeatable systems, documenting processes, creating franchise-ready businesses
- **Key Frameworks:** E-myth systems, process documentation, operational architecture, business model systems
- **Questions to Ask Him:**
  - How do I build systems that work without me?
  - How do I document my training methodology?
  - How do I scale operations to multiple locations/instructors?
  - How do I build a franchise-ready model?

---

## TRADE SCHOOL & VOCATIONAL EDUCATION EXPERTS

### **Hector Resendez**
- **Core Expertise:** Trade school model building, WIOA compliance, credential pathways, government funding
- **Primary Methodologies:** ETPL approval process, credential validation, instructor hiring/training, student outcomes tracking, grant management
- **What He Built:** Proven trade school models; expertise in WIOA funding and government education partnerships
- **Best For:** Vocational trainers, credential-based education, government-funded programs, WIOA applicants
- **Key Frameworks:** WIOA compliance, credential pathways, ETPL approval, instructor training, student outcomes
- **Questions to Ask Him:**
  - What's the timeline for WIOA ETPL approval?
  - What credential pathway makes sense for our model?
  - How do I ensure student outcomes meet government standards?
  - What's the cost/structure for government-funded training?

---

## GROWTH & SCALING EXPERTS

### **Y Combinator Partners**
- **Core Expertise:** Startup scaling, growth metrics, fundraising, founder development
- **Primary Methodologies:** Growth frameworks, metric tracking, capital efficiency, founder coaching
- **Best For:** Scalable tech/education models, funding approaches, growth frameworks
- **Key Frameworks:** Y Combinator startup methodology, growth metrics, capital efficiency

---

## MARKETING & AUDIENCE EXPERTS

### **Russell Brunson**
- **Core Expertise:** Sales funnels, conversion optimization, online marketing, growth strategies
- **Primary Methodologies:** Sales funnel architecture, email marketing, conversion optimization, affiliate marketing
- **What He Built:** ClickFunnels platform; $100M+ in funnel-based revenue; marketing authority
- **Best For:** Online course creators, funnel optimization, conversion improvements, marketing automation
- **Key Frameworks:** Sales funnel architecture, email sequences, conversion optimization, affiliate strategies
- **Questions to Ask Him:**
  - How do I build a sales funnel for my training?
  - What's my enrollment/conversion funnel?
  - How do I optimize from signup to student?
  - What email sequences move students through?

---

### **Neil Patel**
- **Core Expertise:** SEO, content marketing, digital marketing strategy, platform building
- **Primary Methodologies:** SEO-driven content, digital marketing systems, analytics, traffic generation
- **What He Built:** Multiple digital marketing platforms; authority in SEO and content strategy
- **Best For:** Content creators, SEO-focused businesses, digital marketing strategy, organic growth
- **Key Frameworks:** SEO content strategy, analytics-driven decisions, digital marketing systems
...
When a user provides their context, search this database by:
1. **Matching their goals** to expert specializations
2. **Matching their expertise areas** to complementary advisors
3. **Selecting 6-8 experts** with diverse but complementary specializations
4. **Prioritizing experts** who have built in their exact domain or adjacent domains

### For Direct Expert Calls
The skill helps users understand which expert to call for specific types of questions:
- Strategy questions → Justin Welsh, Alex Hormozi, Seth Godin
- Positioning/messaging questions → David C. Baker, Donald Miller, Gary Vaynerchuk
- Product/curriculum questions → Tiago Forte, Arvid Kahl
- Operations questions → Dan Martell, Michael Gerber
...
To add new experts to this database, use this template:

```markdown
### **[EXPERT_NAME]**
- **Core Expertise:** [What they're known for]
- **Primary Methodologies:** [Their frameworks and systems]
- **What They Built:** [Their track record and results]
- **Best For:** [What types of businesses/goals]
- **Key Frameworks:** [Names of their frameworks]
...
*This database is continually updated as new experts emerge and as users provide feedback on expert matches and effectiveness.*
